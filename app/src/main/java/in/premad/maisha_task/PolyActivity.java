...
public class PolyActivity extends AppCompatActivity
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        Polyline polyline1 = googleMap.addPolyline(new PolylineOptions()
                .clickable(true)
                .add(
                        new LatLng(26.8530, 75.8047),
                        new LatLng(26.8037, 75.8085)
...
/*
        ...
        mMarker = googleMap.addMarker(new MarkerOptions().position(new LatLng(26.8530, 75.8047)));

        googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(26.8530, 75.8047), 4));
    ...
    private void stylePolyline(Polyline polyline) {
        ...
        switch (type) {
            ...
            /*    polyline.setStartCap(
                        new CustomCap(
                                BitmapDescriptorFactory.fromResource(R.drawable.ic_baseline_arrow_back_24), 10));
             */   break;
            case "B":
