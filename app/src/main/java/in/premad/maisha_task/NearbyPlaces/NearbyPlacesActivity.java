...
public class NearbyPlacesActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace) {
        ...
        googlePlacesUrl.append("&key=" + "AIzaSyDXag1Tt3SDyc_RWQQcsCrs3Ez7dRWwBEo");
    ...
    public void onLocationChanged(Location location) {
        ...
        Toast.makeText(NearbyPlacesActivity.this,"Your Current Location", Toast.LENGTH_LONG).show();
